/*!
 * Stockfish.js 19 (c) 2026, Chess.com, LLC
    ...
    function e(e) {
      ...
      function ge(e, n, t, r) {
        ...
        var f,
          ...
          l = {
            ...
            "%j": function (e) {
              return a(e.L + ye(A(e.J + 1900) ? x : R, e.K - 1), 3);
            },
            "%m": function (e) {
              return a(e.K + 1, 2);
            },
            ...
            "%U": function (e) {
              var n = new Date(e.J + 1900, 0, 1),
                t = 0 === n.getDay() ? n : C(n, 7 - n.getDay());
              return i(t, (e = new Date(e.J + 1900, e.K, e.L))) < 0
                ? a(
                    Math.ceil(
                      (31 -
                        t.getDate() +
                        (ye(A(e.getFullYear()) ? x : R, e.getMonth() - 1) -
                          31) +
                        e.getDate()) /
                        7,
                    ),
            ...
            "%V": function (e) {
              var n = new Date(e.J + 1901, 0, 4),
                t = u(new Date(e.J + 1900, 0, 4)),
                n = u(n),
                r = C(new Date(e.J + 1900, 0, 1), e.O);
              return i(r, t) < 0
                ? "53"
                : i(n, r) <= 0
                  ? "01"
      ...
      var I,
        ...
        xe =
          (!(function () {
            ...
            function r(e) {
              return (
                ...
                .then(e, function (e) {
                  (d("failed to asynchronously prepare wasm: " + e), D(e));
                });
            }
            var o = { a: Ae };
            if (
          ...
          (f.___errno_location = function () {
            return (xe = f.___errno_location = f.asm.v).apply(null, arguments);
          })),
        Re =
          ...
          (f._free = function () {
            return (Re = f._free = f.asm.x).apply(null, arguments);
          })),
        Ce = (f._malloc = function () {
          return (Ce = f._malloc = f.asm.z).apply(null, arguments);
        }),
        Fe = (f.stackSave = function () {
          return (Fe = f.stackSave = f.asm.A).apply(null, arguments);
        }),
        Ee = (f.stackRestore = function () {
          return (Ee = f.stackRestore = f.asm.B).apply(null, arguments);
        }),
        P = (f.stackAlloc = function () {
          return (P = f.stackAlloc = f.asm.C).apply(null, arguments);
        }),
        Oe = (f.dynCall_vi = function () {
          return (Oe = f.dynCall_vi = f.asm.D).apply(null, arguments);
        }),
        Te = (f.dynCall_v = function () {
          return (Te = f.dynCall_v = f.asm.E).apply(null, arguments);
        });
      function Y(e) {
          ...
          if (!I && ((I = !0), (f.calledRun = !0), !v)) {
            if (
              ...
              var e = a,
                ...
                r = P(4 * (t + 1));
              g[r >> 2] = V(s);
              for (var o = 1; o < t; o++) g[(r >> 2) + o] = V(e[o - 1]);
              g[(r >> 2) + t] = 0;
              try {
                Pe(n(t, r));
              } catch (e) {
      ...
      if (
        ((f._asyncify_start_unwind = function () {
          return (f._asyncify_start_unwind = f.asm.F).apply(null, arguments);
        }),
        (f._asyncify_stop_unwind = function () {
          return (f._asyncify_stop_unwind = f.asm.G).apply(null, arguments);
        }),
        (f._asyncify_start_rewind = function () {
          return (f._asyncify_start_rewind = f.asm.H).apply(null, arguments);
        }),
        (f._asyncify_stop_rewind = function () {
          return (f._asyncify_stop_rewind = f.asm.I).apply(null, arguments);
        }),
          ...
          var i = {
              string: function (e) {
                ...
                return (
                  null != e &&
                    0 !== e &&
                    ((n = 1 + (e.length << 2)), (t = P(n)), z(e, y, t, n)),
                  t
                );
              },
              array: function (e) {
